...
from football_agent.player_strategy import PlayerStrategy


class SimulationParams:
    def __init__(self, names: Tuple[str, str], managers_line_up: Tuple[ManagerLineUpStrategy,  ManagerLineUpStrategy], 
                 managers_action_strategy:  Tuple[ManagerActionStrategy, ManagerActionStrategy], 
                 players_action_strategy: Tuple[PlayerStrategy, PlayerStrategy]) -> None:
