...
selected_keys = ["short_name", "club_name", "player_positions", "overall", "pace", "shooting", "passing", "dribbling", "defending", "physic",
                 "attacking_finishing", "mentality_vision", "power_stamina", "mentality_aggression", "mentality_interceptions", "movement_reactions"]

df = pd.read_csv('data/players_22.csv')

print(df[df['short_name'] == 'L. Messi'])
